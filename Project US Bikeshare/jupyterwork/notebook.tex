...
\textbf{Answer}: How many people are actually using Bike Share System?
In which city Bike Share System is generating most profit?
...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} import all necessary packages and functions.}
        ...
        \PY{k+kn}{from} \PY{n+nn}{datetime} \PY{k}{import} \PY{n}{date} \PY{c+c1}{\PYZsh{}operations to parse dates}
        \PY{k+kn}{import} \PY{n+nn}{calendar} \PY{c+c1}{\PYZsh{}for getting weekday name from date}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{if} \PY{n}{city}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{w}\PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (ms)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                \PY{n}{duration}\PY{o}{=}\PY{n}{w}\PY{o}{/}\PY{l+m+mi}{1000}\PY{o}{/}\PY{l+m+mi}{60}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{n}\PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tripduration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                \PY{n}{duration}\PY{o}{=}\PY{n}{n}\PY{o}{/}\PY{l+m+mi}{60}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{if} \PY{n}{city}\PY{o}{==}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{NYC}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                \PY{n}{n}\PY{o}{=}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{n}{n}\PY{o}{=}\PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{n}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{S}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                \PY{n}{month}\PY{o}{=}\PY{n}{n}\PY{o}{.}\PY{n}{month}
                \PY{n}{hour}\PY{o}{=}\PY{n}{n}\PY{o}{.}\PY{n}{hour}
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{calendar}\PY{o}{.}\PY{n}{day\PYZus{}name}\PY{p}{[}\PY{n}{n}\PY{o}{.}\PY{n}{weekday}\PY{p}{(}\PY{p}{)}\PY{p}{]}
            \PY{k}{elif} \PY{n}{city}\PY{o}{==}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Washington}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                \PY{n}{w}\PY{o}{=}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{n}{w}\PY{o}{=}\PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{w}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                \PY{n}{month}\PY{o}{=}\PY{n}{w}\PY{o}{.}\PY{n}{month}
                \PY{n}{hour}\PY{o}{=}\PY{n}{w}\PY{o}{.}\PY{n}{hour}
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{calendar}\PY{o}{.}\PY{n}{day\PYZus{}name}\PY{p}{[}\PY{n}{w}\PY{o}{.}\PY{n}{weekday}\PY{p}{(}\PY{p}{)}\PY{p}{]}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{c}\PY{o}{=}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
                \PY{n}{c}\PY{o}{=}\PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{c}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                \PY{n}{month}\PY{o}{=}\PY{n}{c}\PY{o}{.}\PY{n}{month}
                \PY{n}{hour}\PY{o}{=}\PY{n}{c}\PY{o}{.}\PY{n}{hour}
                \PY{n}{day\PYZus{}of\PYZus{}week}\PY{o}{=}\PY{n}{calendar}\PY{o}{.}\PY{n}{day\PYZus{}name}\PY{p}{[}\PY{n}{c}\PY{o}{.}\PY{n}{weekday}\PY{p}{(}\PY{p}{)}\PY{p}{]}
...
\textbf{Answer}: New York has the highest number of trips with numbers
going as high as 276798. Again, New York has the highest proportions of
trip made by the subscriber with a percentage of 88.835902\%. Chicago
has the highest percentage of the short-term customers with 23.774799\%.
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                ...
                \PY{c+c1}{\PYZsh{}compute proportion of trips made by subscribers}
                \PY{n}{p\PYZus{}subscribers} \PY{o}{=} \PY{n}{n\PYZus{}subscribers}\PY{o}{/}\PY{n}{n\PYZus{}total}
                \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                \PY{k}{return}\PY{p}{(}\PY{n}{n\PYZus{}subscribers}\PY{p}{,} \PY{n}{n\PYZus{}customers}\PY{p}{,} \PY{n}{n\PYZus{}total}\PY{p}{,} \PY{n}{p\PYZus{}subscribers}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
        ...
        \PY{n}{n}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{w}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
        \PY{n}{c}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{columns} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{city}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{total\PYZus{}trips}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{age of subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{age of customers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{c+c1}{\PYZsh{} column names}
         \PY{n}{cities} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k}{as} \PY{n+nn}{pd}
         \PY{n}{new\PYZus{}obs} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{columns} \PY{o}{=} \PY{n}{columns}\PY{p}{)} \PY{c+c1}{\PYZsh{}creating an empty dataframe with only columns names}
         
         \PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{city}\PY{p}{,} \PY{n}{filename} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{n}{cities}\PY{p}{,} \PY{p}{[}\PY{n}{n}\PY{p}{,}\PY{n}{w}\PY{p}{,}\PY{n}{c}\PY{p}{]}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{}[n,w,c] is the list of filename for each city mentioned in above cell}
             \PY{c+c1}{\PYZsh{}filling the rows}
             \PY{n}{new\PYZus{}obs}\PY{o}{.}\PY{n}{loc}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{p}{[}\PY{n}{city}\PY{p}{,}\PY{n+nb}{list}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{n+nb}{list}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{100}\PY{p}{,} \PY{l+m+mi}{100} \PY{o}{\PYZhy{}} \PY{n+nb}{list}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}\PY{o}{*}\PY{l+m+mi}{100}\PY{p}{]}
         \PY{n}{new\PYZus{}obs}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:}          city total\_trips  \%age of subscriber  \%age of customers
...
\textbf{Answer}: Average trip length for each city is:
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
         ...
         \PY{c+c1}{\PYZsh{}using pandas to work with dataframes}
         \PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k}{as} \PY{n+nn}{pd}
         
         \PY{k}{def} \PY{n+nf}{average\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads the trip data of a city and return the average trip length for that city}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{c+c1}{\PYZsh{}creating dataframe from csv file}
             \PY{n}{trip\PYZus{}data} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{n}{filename}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{}calculate average length of trip for each city }
             \PY{n}{average\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
         
             \PY{k}{return} \PY{p}{(}\PY{n}{average\PYZus{}trip\PYZus{}length}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}Checking the function}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{average\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{average\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{w}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{average\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{c}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
Chicago- 16.5636293688
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k}{def} \PY{n+nf}{more\PYZus{}than\PYZus{}30}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads the trip data of a city and return the proportion of rides made in that city which are longer }
         \PY{l+s+sd}{    than 30 minutes}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{c+c1}{\PYZsh{}setting the counter variable }
             \PY{n}{more\PYZus{}than\PYZus{}30} \PY{o}{=} \PY{l+m+mi}{0}
             
             \PY{c+c1}{\PYZsh{}creating dataframe from csv file}
             \PY{n}{trip\PYZus{}data} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{n}{filename}\PY{p}{)}
             
             \PY{k}{for} \PY{n}{duration} \PY{o+ow}{in} \PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{:}
                 \PY{k}{if} \PY{n}{duration} \PY{o}{\PYZgt{}} \PY{l+m+mi}{30}\PY{p}{:}
                     \PY{n}{more\PYZus{}than\PYZus{}30} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                     
             \PY{c+c1}{\PYZsh{}calculating proportion}
             \PY{n}{p\PYZus{}more\PYZus{}than\PYZus{}30} \PY{o}{=} \PY{l+m+mi}{100}\PY{o}{*}\PY{n}{more\PYZus{}than\PYZus{}30}\PY{o}{/}\PY{n+nb}{len}\PY{p}{(}\PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
             
             \PY{k}{return} \PY{p}{(}\PY{n}{p\PYZus{}more\PYZus{}than\PYZus{}30}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{}Checking the function}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{more\PYZus{}than\PYZus{}30}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{more\PYZus{}than\PYZus{}30}\PY{p}{(}\PY{n}{w}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{more\PYZus{}than\PYZus{}30}\PY{p}{(}\PY{n}{c}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: Well, i did that for Washington City, but the ridership
is almost same for all the cities. Customers takes longer rides on
average.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{ridership}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads trip data of a city and returns average of trip duration for each type of user.}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{c+c1}{\PYZsh{}creating dataframe from csv file}
             \PY{n}{trip\PYZus{}data} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{n}{filename}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{}setting the counter variables}
             \PY{n}{customer\PYZus{}duration} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{customer\PYZus{}count} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{subscriber\PYZus{}duration} \PY{o}{=} \PY{l+m+mi}{0}
             \PY{n}{subscriber\PYZus{}count} \PY{o}{=} \PY{l+m+mi}{0}
         
             \PY{k}{for} \PY{n}{duration}\PY{p}{,}\PY{n}{user\PYZus{}type} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{:}
                 \PY{k}{if} \PY{n}{user\PYZus{}type} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                     \PY{n}{subscriber\PYZus{}duration} \PY{o}{+}\PY{o}{=} \PY{n}{duration}
                     \PY{n}{subscriber\PYZus{}count} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                 \PY{k}{else}\PY{p}{:}
                     \PY{n}{customer\PYZus{}duration} \PY{o}{+}\PY{o}{=} \PY{n}{duration}
                     \PY{n}{customer\PYZus{}count} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
             \PY{n}{customer\PYZus{}avg} \PY{o}{=} \PY{n}{customer\PYZus{}duration}\PY{o}{/}\PY{n}{customer\PYZus{}count}
             \PY{n}{subscriber\PYZus{}avg} \PY{o}{=} \PY{n}{subscriber\PYZus{}duration}\PY{o}{/}\PY{n}{subscriber\PYZus{}count}
                 
             \PY{k}{return} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customer Average\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{customer\PYZus{}avg}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscriber Average\PYZhy{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{subscriber\PYZus{}avg}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ridership}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ridership}\PY{p}{(}\PY{n}{w}\PY{p}{)}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Chicago\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ridership}\PY{p}{(}\PY{n}{c}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} load library}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distance commuted}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
...
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
         ...
         \PY{c+c1}{\PYZsh{}import washington\PYZsq{}s trip info as dataframe}
         \PY{n}{trip\PYZus{}data}\PY{o}{=}\PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{n}{w}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{c+c1}{\PYZsh{}creating a histogram for all trip durations}
         \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{All time Duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{People commuting(all time)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
    ...
    If you followed the use of the .hist() and .show() functions exactly
like in the example, you're probably looking at a plot that's completely
unexpected. The plot consists of one extremely tall bar on the left,
maybe a very short second bar, and a whole lot of empty space in the
center and right. Take a look at the duration values on the x-axis. This
suggests that there are some highly infrequent outliers in the data.
Instead of reprocessing the data, you will use additional parameters
with the .hist() function to limit the range of data that is plotted.
Documentation for the function can be found {[}here{]}.

Question 5: Use the parameters of the .hist() function to plot the
distribution of trip times for the Subscribers in your selected city. Do
the same thing for only the Customers. Add limits to the plots so that
only trips of duration less than 75 minutes are plotted. As a bonus, set
the plots up so that bars are in five-minute wide intervals. For each
group, where is the peak of each distribution? How would you describe
the shape of each distribution?

Answer: Peak for subscriber is seen between 5-10 minutes, for customers
it is between 15-20 minutes.Shape of each distribution is right
skewed.Distribution for subscribers is more right skewed.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
         \PY{k+kn}{import} \PY{n+nn}{seaborn} \PY{k}{as} \PY{n+nn}{sns}
         \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
         
         \PY{c+c1}{\PYZsh{}g = sns.FacetGrid(trip\PYZus{}data, col=\PYZdq{}user\PYZus{}type\PYZdq{})}
         \PY{c+c1}{\PYZsh{}g=g.map(plt.hist, \PYZsq{}duration\PYZsq{})}
         \PY{n}{customers} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{n}{subscribers} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{k}{for} \PY{n}{duration}\PY{p}{,} \PY{n}{user} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{:}
             \PY{k}{if} \PY{n}{user} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                 \PY{n}{customers}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{duration}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{subscribers}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{duration}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{subscribers}\PY{p}{,} \PY{n}{bins} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{min}\PY{p}{(}\PY{n}{subscribers}\PY{p}{)}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{subscribers}\PY{p}{)} \PY{o}{+} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlim}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{]}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{People as Subscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{customers}\PY{p}{,} \PY{n}{bins} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n+nb}{min}\PY{p}{(}\PY{n}{customers}\PY{p}{)}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{customers}\PY{p}{)} \PY{o}{+} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}\PY{p}{;}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlim}\PY{p}{(}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{]}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{People as Customers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
\textbf{Answer}: On analysing more on Washington city, I've found that
there is a different pattern of ridership on weekdays vs weekends. We
can easily see that Subscribers are more likely to use this sytem on
Saturday. While same trend is noticed for Customers too. Average usage
of time change depends on the time of the week too. The values from the
given below table shows us the amount of time spend by both the
subscriber and the customer.
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
         ...
         \PY{c+c1}{\PYZsh{}Creating two dataframes, each for subscriber and customers for comparing trends over weekdays}
         \PY{c+c1}{\PYZsh{}trip\PYZus{}data\PYZus{}1 = trip\PYZus{}data[[\PYZsq{}user\PYZus{}type\PYZsq{}, \PYZsq{}duration\PYZsq{}, \PYZsq{}day\PYZus{}of\PYZus{}week\PYZsq{}]]}
         \PY{n}{trip\PYZus{}data}
         \PY{n}{columns} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n}{trip\PYZus{}data}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{n}{columns}\PY{p}{,} \PY{n}{axis} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{,} \PY{n}{inplace} \PY{o}{=} \PY{k+kc}{True}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{}trip\PYZus{}data}
         \PY{n}{my\PYZus{}sub} \PY{o}{=} \PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
         \PY{n}{my\PYZus{}cus} \PY{o}{=} \PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{n}{trip\PYZus{}data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{n}{my\PYZus{}sub} \PY{o}{=} \PY{n}{my\PYZus{}sub}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
         \PY{n}{my\PYZus{}cus} \PY{o}{=} \PY{n}{my\PYZus{}cus}\PY{o}{.}\PY{n}{groupby}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{sub\PYZus{}trend} \PY{o}{=} \PY{n}{my\PYZus{}sub}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{kind} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bar}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{green}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{title}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Subscribers}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{sub\PYZus{}trend}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of hours}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{n}{cus\PYZus{}trend} \PY{o}{=} \PY{n}{my\PYZus{}cus}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{kind}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bar}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{red}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{title}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Customers}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
         \PY{n}{cus\PYZus{}trend}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of hours}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
\textbf{Answer}: With so many emerging trends around big data and
analytics, IT organizations need to create conditions that will allow
analysts and data scientists to experiment on various aspect of a given
data. Just for instance take big data, analysts have not only more data
to work with, but also the processing power to handle large numbers of
records with many attributes. From this subect i've learned that Data
analysis helps us in making Data-driven decisions like Stock market and
flight management systems are such a good apllication of Data Analytics
and Data sciences.
